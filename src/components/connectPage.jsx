...
const ConnectPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-300 flex items-center justify-center relative overflow-hidden">
      <div className="absolute z-3 top-[10vh] h-[40vh] w-[40vh] left-[5vw] rotate-[-45deg] md:top-[15vh] md:h-[45vh] md:w-[45vh] md:left-[5vw]">
        <img className="h-full w-full object-contain" src={cansat} alt="" />
      </div>
      <div className="absolute z-3 top-[10vh] h-[40vh] w-[40vh] right-[5vw] rotate-[45deg] md:top-[15vh] md:h-[45vh] md:w-[45vh] md:right-[10vw]">
        <img className="h-full w-full object-contain" src={cansat} alt="" />
      </div>
      <div className="relative md:bottom-[60px] w-[90%] max-w-[400px] min-h-fit z-[5] rounded-[20px] shadow-[rgb(255, 255, 0)] hover:shadow-[0_0_50px_rgba(255,255,0,7.25)] bg-[#0E0D28E5] flex hover:scale-[105%] transition-all duration-200 cursor-pointer items-center justify-between gap-[17px] flex-col p-[10px] md:p-[20px]">
        <div className="h-16 md:h-20 w-full flex items-center justify-center gap-[10px] md:gap-[20px]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 51 50"
          ...
          <h2 className="font-iceland text-[24px] md:text-[30px] font-bold text-white tracking-wider">
            Flight Connection
          </h2>
        </div>
        <div className="w-[90%] md:w-[80%] flex items-center justify-center gap-[15px] md:gap-[20px] flex-col">
          <div className="relative w-full">
            <input
              value={port}
              onChange={(e) => {setPort(e.target.value)}}
              className="h-[45px] md:h-[50px] w-full flex items-start focus:border-[3px] focus:border-yellow-300 rounded-[20px] justify-center px-[60px] md:px-[70px] text-[20px] md:text-[25px] font-iceland outline-none"
              placeholder="Port"
              type="text"
            />
            <svg
              className="absolute left-[15px] md:left-[20px] top-1/2 transform -translate-y-1/2 w-6 h-6 md:w-7 md:h-7"
              viewBox="0 0 40 41"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <div className="relative w-full">
            <input
              ...
              className="h-[45px] md:h-[50px] w-full flex rounded-[20px] focus:border-[3px] focus:border-yellow-300 items-start justify-center px-[60px] md:px-[70px] text-[20px] md:text-[25px] font-iceland outline-none"
        ...
        <div className="h-[80px] md:h-[90px] w-full flex items-center justify-center pb-[20px] md:pb-[30px]">
          <button className="h-[45px] md:h-[50px] w-[80%] md:w-[50%] focus:scale-[110%] focus:font-bold bg-yellow-300 rounded-[20px] text-[20px] md:text-[25px] font-iceland text-black hover:scale-[110%] hover:border-2 hover:border-white hover:bg-yellow-400 transition-all duration-200 ease-in-out">
            Connect
          </button>
        </div>
      </div>
